...
function annabelApiContracts(): array
{
    return [
        'codemonster-ru/annabel' => [
            ...
            'internal' => [
                '#^src/Bootstrap/.+\.php$#',
                '#^src/Container/ServiceAttributeRegistrar\.php$#',
                '#^src/Console/Commands/.+\.php$#',
                '#^src/Database/.+\.php$#',
                '#^src/Routing/RouteAttributeRegistrar\.php$#',
                '#^src/Support/.+\.php$#',
            ],
        ],
        'codemonster-ru/api-resource' => annabelApiAll(),
        'codemonster-ru/auth' => annabelApiAll(),
        ...
        'codemonster-ru/events' => annabelApiAll(),
        'codemonster-ru/filesystem' => annabelApiAll(),
        'codemonster-ru/http' => annabelApiAll(),
        'codemonster-ru/http-client' => annabelApiAll(),
        'codemonster-ru/logging' => annabelApiAll(),
        'codemonster-ru/mail' => annabelApiAll(),
        'codemonster-ru/queue' => annabelApiAll(),
        ...
        'codemonster-ru/scheduler' => annabelApiAll(),
        ...
        'codemonster-ru/validation' => annabelApiAll(),
